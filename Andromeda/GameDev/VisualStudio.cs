...
namespace Andromeda.GameDev
{
    static class VisualStudio
    {
        ...
        public static bool AddFilesToSolution(string solution, string projectName, string[] files)
        {
            ...
            {
                Debug.WriteLine(ex.Message);
                Debug.WriteLine("failed to add files to Visual Studio");
                return false;
            }
            return true;
        }
        ...
        {
            if (BuildDone) return;
            if (success) Logger.Log(MessageType.Info, $"Building {projectConfig} successful");
            else Logger.Log(MessageType.Error, $"Building {projectConfig} failed");
